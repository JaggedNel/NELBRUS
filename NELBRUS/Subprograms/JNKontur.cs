    ...
    class JNKontur: InitSubP {
        ...
        class TP: SdSubPCmd {
            ...
            public TP(ushort id, SubP p) : base(id, p) {
                ...
                Tangle = 0;
                switchingsusp = false;
                SuspensionMode = SuspensionModes.sport;
            ...
            void RotateRull() {
                ...
                if (RemoteDriver.MoveIndicator.X == 0)
                    destangl = 0;
                else {
                    if (RemoteDriver.MoveIndicator.X < 0)
                        mult = -1;
            ...
            string CmdSSM(List<string> a) {
                if (SuspensionMode == SuspensionModes.offroad)
                    SuspensionMode = SuspensionModes.sport;
                else
                    SuspensionMode++;
                switchingsusp = true;
